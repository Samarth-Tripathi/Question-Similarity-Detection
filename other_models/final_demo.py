...
#test_texts_1 = [['What is the capital of USA']]
#test_texts_2 = [['What is the capital of France']]
#test_ids = [['1']]
'''
...
early_stopping =EarlyStopping(monitor='val_acc', patience=14)
bst_model_path = STAMP + '.h5'
model_checkpoint = ModelCheckpoint(bst_model_path, save_best_only=True, save_weights_only=True)

hist = model.fit([data_1_train, data_2_train], labels_train, \
        validation_data=([data_1_val, data_2_val], labels_val), \
        epochs=12, batch_size=2048, shuffle=True, \
