...
'''
#test_texts_1 = ['What time does the bus leave']
#test_texts_2 = ['What is the current time']
#test_ids = ['1']

test_texts_1 = ['How hot is Sahara desert']
test_texts_2 = ['How hot is Sahara desert']
test_ids = ['1']

#with codecs.open(TEST_DATA_FILE, encoding='utf-8') as f:
#    reader = csv.reader(f, delimiter=',')
#    header = next(reader)
for values in zip(test_texts_1,test_texts_2,test_ids): 
    print values
    #for values in reader:
    test_texts_1.append(text_to_wordlist(values[0]))
    test_texts_2.append(text_to_wordlist(values[1]))
    test_ids.append(values[2])
...
model.load_weights('Final2_demo.h5')
########################################
## add class weight
########################################
if re_weight:
