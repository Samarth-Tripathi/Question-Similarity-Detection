...
from keras.layers import LSTM, Embedding, Dense, Dropout, Reshape, Merge, BatchNormalization, TimeDistributed, Lambda
...
modela = Sequential()
modela.add(Merge([model3, model4], mode='mul'))
...
def v_dif_outputshape(input_shape):
...
modelb = Sequential()
modelb.add(Merge([model3, model4], mode=v_dif, output_shape=v_dif_outputshape))
modelb.add(Dense(units*2))
#modelb.add(BatchNormalization())
modelb.add(Activation('relu'))
modelb.add(Dropout(dropout))

modelc = Sequential()
modelc.add(Merge([model3, model4], mode='concat'))
modelc.add(Dense(units*2))
#modelc.add(BatchNormalization())
modelc.add(Activation('relu'))
modelc.add(Dropout(dropout))

modelc.add(Dense(units))
#modelc.add(BatchNormalization())
modelc.add(Activation('relu'))
modelc.add(Dropout(dropout))

modeld = Sequential()
modeld.add(Merge([modela, modelb], mode='concat'))
modeld.add(Dense(units*2))
#modeld.add(BatchNormalization())
modeld.add(Activation('relu'))
modeld.add(Dropout(dropout))

modeld.add(Dense(units))
#modeld.add(BatchNormalization())
modeld.add(Activation('relu'))
modeld.add(Dropout(dropout))

model = Sequential()
model.add(Merge([modelc, modeld], mode='concat'))
...
with open('predictions_3.csv', 'wb') as csvfile:
