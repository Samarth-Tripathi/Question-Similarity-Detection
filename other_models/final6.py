...
hist = model.fit([data_1_train, data_2_train, data_1_train, data_2_train], labels_train, \
        validation_data=([data_1_val, data_2_val, data_1_val, data_2_val], labels_val, weight_val), \
...
preds = model.predict([test_data_1, test_data_2, test_data_1, test_data_2], batch_size=256, verbose=1)
preds += model.predict([test_data_2, test_data_1, test_data_2, test_data_1], batch_size=256, verbose=1)
preds += model.predict([test_data_2, test_data_1, test_data_1, test_data_2], batch_size=256, verbose=1)
preds += model.predict([test_data_1, test_data_2, test_data_2, test_data_1], batch_size=256, verbose=1)
preds /= 4

submission = pd.DataFrame({'test_id':test_ids, 'is_duplicate':preds.ravel()})
submission.to_csv('final_6.csv', index=False)
