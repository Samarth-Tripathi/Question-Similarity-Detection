...
from keras.layers import Embedding, Dense, Dropout, Reshape, Merge, BatchNormalization, TimeDistributed, Lambda, Activation, LSTM, Flatten, Convolution1D, GRU, MaxPooling1D, MaxPooling2D, Conv2D
...
model = Sequential()
model.add(Merge([model5, model6], mode='concat'))
...
'''
MAX_SEQUENCE_LENGTH = max_question_len
...
Q1.add(Embedding(nb_words + 1,
                 ...
                 trainable=False))
Q1.add(Reshape((1, MAX_SEQUENCE_LENGTH, EMBEDDING_DIM)))
Q1.add(Conv2D(32, (3, 3), activation='relu', data_format='channels_first' ))
Q1.add(Conv2D(32, (3, 3), activation='relu', data_format='channels_first' ))
Q1.add(MaxPooling2D(pool_size=(2, 2)))
...
Q2.add(Embedding(nb_words + 1,
                 ...
                 input_length=MAX_SEQUENCE_LENGTH,
                 trainable=False))
Q2.add(Reshape((1, MAX_SEQUENCE_LENGTH, EMBEDDING_DIM)))
Q2.add(Conv2D(32, (3, 3), activation='relu', data_format='channels_first' ))
Q2.add(Conv2D(32, (3, 3), activation='relu', data_format='channels_first' )),
Q2.add(MaxPooling2D(pool_size=(2, 2)))
#Q2.add(BatchNormalization())
Q2.add(Dropout(0.2))
Q2.add(Conv2D(32, (3, 3), activation='relu', data_format='channels_first' ))
Q2.add(Conv2D(32, (3, 3), activation='relu', data_format='channels_first' )),
Q2.add(MaxPooling2D(pool_size=(2, 2)))
