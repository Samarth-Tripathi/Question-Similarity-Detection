...
history = model.fit([train_q1, train_q2, train_q1, train_q2],
                    ...
                    validation_data = ([val_q1,val_q2,val_q1,val_q2],val_l, weight_val),
                    verbose=True,
                    shuffle=True,
...
predictions += model.predict([test_q2, test_q1, test_q2, test_q1], verbose= True)
predictions /= 2
