...
model5 = Sequential()
model5.add(Embedding(nb_words,
                     embedding_dim,
                     weights = [g_word_embedding_matrix],
                     input_length = max_question_len,
                     trainable = False))

model5.add(Convolution1D(filters = nb_filter,
...
model6 = Sequential()
model6.add(Embedding(nb_words,
                     embedding_dim,
                     weights = [g_word_embedding_matrix],
                     input_length = max_question_len,
                     trainable = False))

model6.add(Convolution1D(filters = nb_filter,
                         kernel_size = filter_length,
                         padding = 'same'))
...
#modelc.add(Dense(num_dense*2, kernel_initializer=weights, bias_initializer=bias))
...
#modeld.add(Dense(num_dense*2, kernel_initializer=weights, bias_initializer=bias))
...
hist = model.fit([data_1_train, data_2_train, data_1_train, data_2_train, data_1_train, data_2_train, data_1_train, data_2_train, f_tr1], labels_train, \
        validation_data=([data_1_val, data_2_val, data_1_val, data_2_val, data_1_val, data_2_val, data_1_val, data_2_val,  f_v], labels_val, weight_val), \
